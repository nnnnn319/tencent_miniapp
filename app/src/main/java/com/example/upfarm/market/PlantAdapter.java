...
public class PlantAdapter extends RecyclerView.Adapter {
    ...
    public PlantAdapter(Context mContext, Product.ResultBean resultBean) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == LIST) {
            return new PlantAdapter.ListViewHolder(mLayoutInflater.inflate(R.layout.list_item,null), mContext);
        }
        return null;
    }
    ...
    class ListViewHolder extends RecyclerView.ViewHolder {
        ...
        private Context mContext;
        private PlantGridViewAdapter adapter;
        ...
        public void setData(final List<Product.ResultBean.HotBean> data) {
            adapter = new PlantGridViewAdapter(mContext, data);
...
//            });
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (getItemViewType(position) == LIST) {
            PlantAdapter.ListViewHolder hotViewHolder = (PlantAdapter.ListViewHolder) holder;
