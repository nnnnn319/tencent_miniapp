...
public class GoodsCommentAdapter extends RecyclerView.Adapter {
    ...
    public GoodsCommentAdapter(Context mContext, Comment.ResultBean resultBean) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == LIST) {
            return new GoodsCommentAdapter.ListViewHolder(mLayoutInflater.inflate(R.layout.list_item,null), mContext);
        }
        return null;
    }
    ...
    class ListViewHolder extends RecyclerView.ViewHolder {
        ...
        private Context mContext;
        private GoodsCommentGridViewAdapter adapter;
        ...
        public void setData(final List<Comment.ResultBean.CommentBean> data) {
            adapter = new GoodsCommentGridViewAdapter(mContext, data);
...
//            });
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (getItemViewType(position) == LIST) {
            GoodsCommentAdapter.ListViewHolder hotViewHolder = (GoodsCommentAdapter.ListViewHolder) holder;
