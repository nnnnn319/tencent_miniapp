...
//    public static final String BASE = "http://10.0.2.2:8080";
    //使用第三方模拟器--当前电脑的ip地址   192.168.56.1
//    public static final String BASE = "http:// 192.168.56.1:8080";
    //运行到自己的真实手机上：
...
//    public static final String BASE = "http://192.168.191.1:8080";
    ...
    public static String HOME_URL = "http://192.168.0.106:8080/atguigu/json/HOME_URL.json";


    // 请求图片基本URL
//    public static final String BASE_URl_IMAGE = "http://192.168.0.106:8080/atguigu/img";
    public static final String BASE_URl_IMAGE = "http://192.168.0.106:8080";

    public static final String TEST_URL ="http://192.168.56.1:8080/atguigu/json/TXT.json";
