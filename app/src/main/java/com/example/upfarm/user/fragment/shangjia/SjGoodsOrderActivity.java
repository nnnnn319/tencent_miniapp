...
public class SjGoodsOrderActivity extends Activity {

    private Context mContext;
    private Order.ResultBean resultBean;//返回的数据
    private RecyclerView rv_list;
    private SjGoodsOrderAdapter adpter;
    private MyRequest myRequest = new MyRequest();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sj_goods_order);
        mContext =  SjGoodsOrderActivity.this;
        initData();
        findViews();
    }
    ...
    private void getDataFromNet() {
        ...
        OkHttpUtils
                .get()
                .url(myRequest.getUrl()+"/sj/product/order")
                .addParams("farmId", "1")
                .build()
    ...
    private void processData(String json) {
        ...
        if(resultBean != null) {
            //有数据
            //设置适配器
            adpter = new SjGoodsOrderAdapter(mContext,resultBean);
