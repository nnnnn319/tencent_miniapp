...
public class SjPlantOrderActivity extends Activity {

    private Context mContext;
    private Order.ResultBean resultBean;//返回的数据
    private RecyclerView rv_list;
    private SjPlantOrderAdapter adpter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext =  SjPlantOrderActivity.this;
        initData();
        findViews();
    }
    ...
    private void getDataFromNet() {
        ...
        OkHttpUtils
                .get()
                .url(myRequest.getUrl()+"/sj/seed/order")
                .addParams("farmId", "1")
                .build()
    ...
    private void processData(String json) {
        ...
        if(resultBean != null) {
            //有数据
            //设置适配器
            adpter = new SjPlantOrderAdapter(mContext,resultBean);
